...
const HeaderService = () => {
    ...
    return (
        <div className="bg-cover bg-center min-h-screen flex justify-center items-center team-hero bg-service">
            <div className="container mx-auto px-6 md:px-20 py-8 items-center flex flex-col md:flex-row">
                <div className="md:w-1/2 md:pr-8" data-aos='fade-right'>
                    <p className="text-white font-bold text-3xl lg:text-5xl mb-6 text-team">Experience the Best Service with Us!</p>
