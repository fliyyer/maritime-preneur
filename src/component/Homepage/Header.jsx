...
const HeaderService = () => {
    ...
    return (
        <div className="bg-cover bg-center flex justify-center items-center min-h-screen bg-service">
            <div className="container mx-auto px-6 sm:px-20 py-8 items-center flex flex-col md:flex-row">
                <div className="md:w-1/2 md:pr-8" data-aos="fade-right" >
                    <p className="text-white font-bold text-3xl md:text-4xl lg:text-6xl mb-8 tracking-wide">MARITIMEPRENEUR</p>
