...
const Service = () => {
    return (
        <div className='container mx-auto flex flex-col justify-between mb-16 pb-10'>
            <div className='text-primary-color mx-auto'>
                ...
                <div className='mx-auto flex flex-col md:flex-row md:flex-wrap gap-7 justify-center'>
                    ...
                    <div className='group bg-white w-72 h-64 p-8 text-center hover:border-4 border-cyan-900 rounded-2xl shadow-xl border-solid border-2'>
